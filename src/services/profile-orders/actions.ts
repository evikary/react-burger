...
export const wsMessage = createAction<any, 'PROFILE_ORDERS_WS_MESSAGE'>('PROFILE_ORDERS_WS_MESSAGE');
export const wsError = createAction<any, 'PROFILE_ORDERS_WS_ERROR'>('PROFILE_ORDERS_WS_ERROR');
